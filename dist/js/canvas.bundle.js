...
function init() {
  ...
  for (var i = 0; i < 100; i++) {
    ...
    var x = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(0 + radius, canvas.width - radius * 2);
    var y = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(0 + radius, canvas.height - radius * 2);
